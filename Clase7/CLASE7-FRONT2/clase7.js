...
function mostrarDatosEnPerfil() {
  // desarrollar la función 👇
   ...
   let cantFavs = document.querySelector("#cant-favoritos");
   ...
   console.log(cantAlbums);
   console.log(cantFavs);
   console.log(contadorAlbum);
   console.log(contadorFav);

   if (contadorAlbum <= 1) {
    cantAlbums.innerHTML = contadorAlbum + " álbumes"}
    else {
    cantAlbums.innerHTML = contadorAlbum + " álbumes"};
    if(contadorFav<=1) {
    cantFavs.innerHTML = contadorFav + " favorito"}
    else {
    cantFavs.innerHTML = contadorFav + " favoritos" }
