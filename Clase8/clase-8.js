...
function marcarFavorito() {
    ...
    botonesLike.forEach(boton => {
        ...
        boton.addEventListener('click', function () {
            ...
            //👇 post click debemos agregar el listener a cada nuevo boton 
            // otra vez ya que el renderizado eliminó lo anterior
            marcarFavorito();
...
// 3- Podemos buscar la posicion del almbum buscado en el array con la funcion 
// .findIndex()
// 4- Si la busqueda nos da un resultado válido, procedemos a borrar el objeto 
// del array
// 5- Acto seguido debemos llamar a las funciones de renderizar y marcar 
// favorito para que sean nuevamente aplicadas.
